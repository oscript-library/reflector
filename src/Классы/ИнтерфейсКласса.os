...
//   Булево - Истина, если интерфейс реалализован в переданной карте класса
//
...
//
// Параметры:
//   ВходящийИнтерфейс - Объект.ИнтерфейсКласса - ссылка на экземпляр класса ИнтерфейсКласса
...
//
//  Возвращаемое значение:
//   Объект.ИнтерфейсКласса - ссылка на текущий экземпляр класса
//
